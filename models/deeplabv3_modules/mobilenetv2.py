...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        #注意：这边的先256,256,32进入，然后如果s步为2，则需要原来的大小除以2为现在的大小，即第二行256, 256, 16 -> 128, 128, 24，而24是已经注定的前面c的大小
            # t, c, n, s
            [1, 16, 1, 1], # 256, 256, 32 -> 256, 256, 16
            [6, 24, 2, 2], # 256, 256, 16 -> 128, 128, 24   2(InvertedResidual重复的次数)
        ...
        # 假设输入图片是512, 512, 3 -> 256, 256, 32
        self.features = [conv_bn(3, input_channel, 2)]  #conv_bn(输入, 输出, 步长2) 利用一个3×3，步长为2×2的卷积进行特征提取
